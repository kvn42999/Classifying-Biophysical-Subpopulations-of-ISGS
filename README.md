...
```mermaid
graph TD
A[Raw MRC/TIFF Files] --> B[Vesicle Analysis Pipeline]
B --> C[Feature Extraction + Distance Calculation]
C --> D[Per-Cell DataFrames]
D --> E[Granule Analysis]
E --> F[Aggregation Across Conditions]
F --> G[Filtered Datasets]
G --> H[CSV Outputs / Downstream Analysis]
